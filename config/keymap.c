...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	SFT_T(KC_SCLN),    CTL_T(KC_Q),      ALT_T(KC_J),    GUI_T(KC_K),        HYPR_T(KC_X),    HYPR_T(KC_B),    GUI_T(KC_M),       ALT_T(KC_W),      CTL_T(KC_V),      SFT_T(KC_Z),
	                                                     LT(LOWER, KC_ENT),  KC_SPC,          KC_BSPC,         LT(RAISE, KC_TAB)
    ),

    [LOWER] = LAYOUT_split_3x5_2(
	XXXXXXX,            KC_F1,           KC_F2,          KC_F3,              XXXXXXX,         KC_PSCR,         KC_F10,            KC_F11,           KC_F12,           KC_DEL, 
	XXXXXXX,            KC_F4,           KC_F5,          KC_F6,              XXXXXXX,         KC_LEFT,         KC_DOWN,           KC_UP,            KC_RIGHT,         KC_ESC,
	XXXXXXX,            KC_F7,           KC_F8,          KC_F9,              XXXXXXX,         KC_HOME,         KC_PGDN,           KC_PGUP,          KC_END,           KC_CAPS,
